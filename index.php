...
<body>
    ...
    <nav class="text-dark">
        <div class="nav-container">
            ...
            <ul class="text-white text-bold fs-1">
                <li class="p-1 m-1"><a class="current" href="./index.html">Home</a></li>
                <li class="p-1 m-1"><a href="login.php">Login</a></li>
    ...
    <section id="about">
        <div class="container py-5">
            ...
            <div id="about-content">
                <h1 class="theme-font fs-4 text-center mb-4">Komitmen Kami</h1>
    ...
    <section id="gallery" class="p-5">
        <div class="container">
            <h2 class="text-center fs-4 mb-4"><span class="underlined-heading">Menu yang Kami Miliki</span></h2>
